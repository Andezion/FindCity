...
-- Примечания по путям: окончательное расположение файлов зависит от версии Flutter и платформенной конфигурации, а указанные пути соответствуют стандартной структуре вывода при сборке через `flutter build`.
